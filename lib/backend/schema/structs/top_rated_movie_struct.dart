...
class TopRatedMovieStruct extends BaseStruct {
  TopRatedMovieStruct({
    int? id,
    String? title,
    String? posterPath,
  ...
  static TopRatedMovieStruct fromMap(Map<String, dynamic> data) =>
      TopRatedMovieStruct(
  ...
  static TopRatedMovieStruct? maybeFromMap(dynamic data) => data is Map
      ? TopRatedMovieStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static TopRatedMovieStruct fromSerializableMap(Map<String, dynamic> data) =>
      TopRatedMovieStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'TopRatedMovieStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is TopRatedMovieStruct &&
        id == other.id &&
        title == other.title &&
...
TopRatedMovieStruct createTopRatedMovieStruct({
  int? id,
  String? title,
  String? posterPath,
  DateTime? releaseDate,
