...
class UpcomingMovieStruct extends BaseStruct {
  UpcomingMovieStruct({
    int? id,
    String? title,
    String? posterPath,
  ...
  static UpcomingMovieStruct fromMap(Map<String, dynamic> data) =>
      UpcomingMovieStruct(
  ...
  static UpcomingMovieStruct? maybeFromMap(dynamic data) => data is Map
      ? UpcomingMovieStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static UpcomingMovieStruct fromSerializableMap(Map<String, dynamic> data) =>
      UpcomingMovieStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'UpcomingMovieStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is UpcomingMovieStruct &&
        id == other.id &&
        title == other.title &&
...
UpcomingMovieStruct createUpcomingMovieStruct({
  int? id,
  String? title,
  String? posterPath,
  DateTime? releaseDate,
